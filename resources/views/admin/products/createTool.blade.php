...
@section('content')
    ...
    <div class="container">
        ...
        /
        <a href="/admin/products/tools/create/{{ $product->id }}" class="link-secondary route active" >اضافه کردن امکان جانبی جدید</a>
    ...
    <div class="alert alert-success text-center" style="margin:10px;">
        اضافه کردن امکان جانبی جدید 
    </div>

    <div class="container">
        <form class="m-form m-form--fit m-form--label-align-right" action="/admin/products/tools/create/{{ $product->id }}" method="post">
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <input type="text" name="count_title" class="form-control m-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <input type="text" name="default_count" class="form-control m-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <input type="text" name="max_count" class="form-control m-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                    </div>
                </div>
